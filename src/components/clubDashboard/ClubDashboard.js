  ...
  return (
    <div className="frame">
      <div className="div">
        ...
        <img className="stadium-icon" alt="Stadium Icon" src="emojione-v1-stadium.svg" />
        <img className="wallet-icon" alt="Wallet Icon" src="solar-wallet-bold.svg" />
        ...
        <img className="account-cog-icon" alt="Account Cog Icon" src="mdi-account-cog-outline.svg" />
        <img
          className="domain-verification-icon"
          alt="Domain Verification Icon"
          src="material-symbols-domain-verification-outline.svg"
        />
        <img className="support-icon" alt="Support Icon" src="flat-color-icons-support.svg" />
        <img className="contract-icon" alt="Contract Icon" src="material-symbols-contract-outline.svg" />
      </div>
    </div>
  );
};
